...
Using `JOIN` find:
1. The name, age, and signature bake of all season 4 contestants 
2. The networks of the top three episodes with the highest viewership
3. The star bakers' showstopper and name for each episode
