# Solving an Ethical Dilema

*This assignment is under construction and is subject to change for the 26-27 school year.* 

## Objective
1. Write a professional memo disagreeing with a superior
2. Cite evidence from the ACM Code of Ethics and Professional Conduct to support your argument
3. Annotate and understand the principles outlined in the ACM Code of Ethics and Professional Conduct. Make connections to current/historical events that relate to these principles.
...
> Sarah Jenkins, the VP of Product, has instructed your team to finalize the software for a pilot launch in three major city hospitals next week. However, your final QA testing revealed a troubling statistic: while the AI boasts a 94% accuracy rate for affluent, native-English-speaking demographics, its accuracy drops to 76% for non-native English speakers and lower-income demographics due to biases in the historical training data.

> When you informally brought this up to Sarah, she replied: "We can't halt the launch. A 76% accuracy rate is still better than the chaotic, understaffed triage desks these hospitals currently have. We will patch the algorithm in version 2.0. Draft me a formal sign-off on the model's readiness by Friday."
